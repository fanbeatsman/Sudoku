...
class Sudoku
{
    ...
    public void placeNumber(int row, int col)throws Exception{ 
...
//            for(int r=1;r<=N;r++){
//            Grid[row][col]=r;
//            if (checkSquare(row,col,r)){
//              break;
//            }
//            else if (checkCol(col,r)){
//              break;
//            }
//             else if (checkRow(row,r)){
//              break;
//            }
//             else{
//               while (Grid[row][col]
